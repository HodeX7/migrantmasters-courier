  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://kitpro.site/delivey/wp-content/uploads/sites/70/2022/02/young-asian-male-courier-with-thermo-bag-wearing-f-2021-09-03-20-53-03-utc-copy.jpg)",
        }}
      >
        ...
        <div className="z-[2] w-full h-full flex flex-col items-center justify-center py-20">
          ...
          <div className="flex items-center justify-center space-x-8 z-2 px-20 mt-auto">
            {services.slice(0, 3).map((item, idx) => (
              <div
                key={idx}
                className="flex flex-col items-start relative gap-y-4 x-6 bg-background px-[2rem] py-[3rem] max-w-[22rem]"
              >
                <div
      ...
      <div className="w-full h-screen flex flex-col items-center justify-center bg-white relative py-20">
        ...
        <div className="flex items-center justify-center space-x-8 mt-12 z-[2] px-20">
          <div className="flex flex-col items-center px-6 bg-white rounded-xl py-4">
            <div className="w-[6rem] h-[6rem] bg-gray flex items-center justify-center rounded-full bg-red-500">
              image
            </div>
            ...
            <p className="text-md text-center">
              Sed sollicitudin magna sit amet lacinia consectetur. Vivamus
              rhoncus accumsan facilisis. Praesent mi mi, placerat eu metus ac,
              porttitor laoreet sem. Praesent sed sem sed augue semper iaculis
              eu in eros. Morbi sed enim at risus semper placerat. Ut non enim
              vitae elit sagittis bibendum venenatis sed nunc.
            </p>
          </div>
        </div>
      </div>
